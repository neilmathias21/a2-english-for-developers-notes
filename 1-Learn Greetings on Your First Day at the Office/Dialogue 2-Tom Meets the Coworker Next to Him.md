...
## Topic: Learn Greetings on Your First Day at the Office  
### Dialogue 2 - Tom Meets the Coworker Next to Him

---

## Situation Summary
Tom introduces himself to Sophie, a coworker sitting next to him. They talk about where they are from, welcome each other, and discuss office equipment such as standing desks and ergonomic tools. Sophie encourages Tom and asks if he’s ready to begin work.
...
| Structure | Example |
|-----------|---------|
| instead of [verb-ing] | *Instead of sitting all the time* |
| a good alternative | *Standing is a good alternative to sitting.* |

### **Using expressions that show enthusiasm**
| Expression | Meaning |
|------------|---------|
| **This is so cool!** | Showing excitement |
...
|--------|---------------|---------|
| **Hi there.** | Friendly informal greeting | *Hi there! How’s it going?* |
| **I'm [name]. I'm the [job role].** | Introducing yourself | *I’m Daniel. I’m the new IT specialist.* |
| **Where are you from?** | Asking about origin or hometown | *Where are you from originally?* |
| **How about you?** | Returning the same question | *I’m from India. How about you?* |
...
- Making small talk helps build relationships with coworkers.
- Asking **Where are you from?** is a common starter conversation.
- Giving compliments creates positivity in the workplace.
- Showing enthusiasm helps create a supportive team environment.
...
- **Hi, I’m [name]. I’m the [job].**

### **Asking about origin**
- **Where are you from?**
- **I’m from [place]. How about you?**

### **Talking about equipment**
- **Is this one of those [object]?**
- **These are great!**
...
## Practice Questions
1. How would you introduce yourself to a coworker sitting next to you?
